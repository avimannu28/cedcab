...
<body>
    ...
    <div class="container-fluid bg-overlay">
        <div class="row text-center">
            ...
            <label for="Sorting" style="margin-left:50px;margin-top:50px;"></label>
...
foreach ($canceled as $key => $value) {
 echo "<tr><td>$value[ride_date]</td><td>$value[from_location]</td><td>$value[to_location]</td><td>$$value[total_fare]</td><td>Pending |<a href='cancel.php?id=".$value['ride_id']."'> Cancel</a></td></tr>";
}
