...
<body>
    ...
    <div class="container-fluid bg-overlay">
        ...
        <div class="ml-4 pb-4 mx-auto mt-5" id="side">
            <div class="container">
                <div class="row">

                        <div class="col col-sm-12 col-12 col-xs-12 m-2 p-1 mt-2 text-center" id="book">
...
?>
                            ...
                            <div class="form-group">
                                <input type="text" class="form-control w-100" placeholder="Luggage Weight" name="luggage"
                                    id="luggages">
                            </div>
