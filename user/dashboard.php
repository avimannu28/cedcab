...
<body>
            ...
            <nav class="navbar navbar-expand-md navbar-light ">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ml-auto pl-auto text-center" id='active'>
                        ...
                        <form action="post">
                            <input type="submit" type='button' name="logout" value="logout"
            ...
            <div class="row align-items-stretch">
                ...
                <div class="c-dashboardInfo col-lg-3 col-md-6">
                 ...
                 <div class="c-dashboardInfo col-lg-3 col-md-6">
                    <div class="wrap">
                        <a href="canceled.php">
                            <h4 class="heading heading5 hind-font medium-font-weight c-dashboardInfo__title">Cancel
    ...
    <footer class="page-footer font-small blue mt-4" style='margin-top:250px!important;'>
        <div class="row">
